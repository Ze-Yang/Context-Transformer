...
from layers.modules.multibox_loss_combined_meta1 import MultiBoxLoss_combined
...
parser.add_argument('--n_shot_task', type=int, default=0,
...
parser.add_argument('--train_episodes', type=int, default=2500, # 500 for 3 shot, # 2521 for n_way = 12, 3782 for n_way = 8
