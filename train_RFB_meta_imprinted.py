...
parser.add_argument('--train_episodes', type=int, default=1000, # 500 for 3 shot, # 2521 for n_way = 12, 3782 for n_way = 8
...
optimizer = optim.SGD([
                            ...
                            {'params': net.base.parameters(), 'lr': args.lr*0.5},
